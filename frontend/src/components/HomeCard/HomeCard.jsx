...
export default function HomeCard() {
    ...
    return (
        <Paper elevation={3} style={{ ...OpenSans, width: '90%', padding: '20px 30px' }}>
            ...
            <p style={{ fontSize: '20px' }}><span className='d-t'>date & thyme</span> is currently under construction.  Please come back later, or reach out to <a href='https://joekgilberto.com/contact' target='_blank'>Joe Gilberto</a> for more information!</p>
